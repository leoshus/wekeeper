/**
 * @author shangyd
 * @Date 2015年11月8日 下午11:42:56
 * Copyright (c) 2015
 **/
package com.sdw.soft.core.shiro.quartz;
 ...
 *
 */
public class SpringQuartzSessionValidationScheduler implements SessionValidationScheduler {
    ...
    ============================================*/
    private static final Logger log = LoggerFactory.getLogger(SpringQuartzSessionValidationScheduler.class);
     ...
     * Default constructor.
     */
    public SpringQuartzSessionValidationScheduler() {
    }
     ...
     */
    public SpringQuartzSessionValidationScheduler(ValidatingSessionManager sessionManager) {
